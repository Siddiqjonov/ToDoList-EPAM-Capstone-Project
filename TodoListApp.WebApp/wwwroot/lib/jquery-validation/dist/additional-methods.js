...
$.validator.addMethod( "cifES", function( value, element ) {
    ...
    const lastDigit = (all_sum).toString().slice(-1);          // use slice() instead of substr
    control_digit = (10 - lastDigit).toString();
    control_digit = parseInt(control_digit, 10) > 9 ? "0" : control_digit;
    control_letter = "JABCDEFGHI".slice(parseInt(control_digit, 10), parseInt(control_digit, 10) + 1); // use slice()
